...
% 筛选40秒到45秒之间的数据
indices = time_seconds >= 35 & time_seconds <= 35.4;
...
% 筛选秒到秒之间的数据
indices = time_seconds >= 35 & time_seconds <= 35.8;
time_filtered = time_seconds(indices);
displacement_filtered = displacement_mm(indices);
...
% 调用函数
[peak_amplitude, main_frequency] = analyze_vibration(time_microseconds, displacement_mm, 100);
